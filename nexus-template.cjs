...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "CalVet Fee Waiver Processing";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Fee Waiver Application";
process.env.TABLE_NAME = process.env.TABLE_NAME || "fee_waiver_application_records";
'use strict';
